        ...
        <AnimatePresence>
          {isOpen && isMobile && (
            <motion.div
              ...
              className="flex flex-col gap-4 fixed top-16 left-0 right-0 w-screen h-auto bg-TAF-200 p-6 shadow-lg border-t border-gray-700 max-h-[calc(100vh-120px)] overflow-y-auto text-center items-center"
            >
              {/* Navigation Links */}
