...
export default function NavigationLink({ linkTo, route }) {
  ...
  return (
    ...
    >
      <Link
        to={route}
        className={`relative w-full whitespace-nowrap md:w-auto text-center py-1 px-3  max-[810px]:min-[760px]:text-sm text-gray-700 hover:text-gray-500 transition-colors border-b-4 border-TAF-100 ${
