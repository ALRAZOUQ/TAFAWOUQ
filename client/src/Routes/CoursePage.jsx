...
const CommentList = () => {
  ...
  // ? Razouq: gauys! amazing work ! I have one note here, It's recomended to write the useEffect just before the return statment 🤗 We can agree on that then move all of them ✅
  useEffect(() => {
