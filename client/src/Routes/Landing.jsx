...
export default function Landing() {
  return (
    <div className="bg-gradient-to-l from-TAFb-200 to-TAFb-100 text-gray-800 font-sans min-h-screen flex flex-col items-center justify-center px-4 rounded-lg">
      <MainHeader />
