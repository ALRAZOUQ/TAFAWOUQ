...
import { TermsAgreement } from "../components/EthicalGuidlinesConformation";
...
export default function Signup() {
  ...
  async function handleSignupSubmission(prevFormState, formData) {
    ...
    if (!agreed) {
      return {
        errors: ["terms not agreed"],
        enteredValues: { username, email, password, confirmPassword },
      };
    }
  ...
  return (
    <Screen className="flex items-center justify-center flex-col p-6">
      <BackButton route={-1} />
